...
| 特性 | agentscope | agno | pydantic-ai | langchain | republic | kimi-cli | kameo | livekit-agents |
|------|------------|------|-------------|-----------|----------|----------|-------|----------------|
| 多智能体 | ✅ MsgHub | ✅ 团队 | 基础 | LangGraph | 基础 | 基础 | ✅ Actor | 基础 |
| 流式处理 | ✅ 支持 | ✅ 支持 | ✅ 一等公民 | ✅ 支持 | ✅ 支持 | ✅ 一等公民 | ✅ 支持 | ✅ 实时 WebRTC |
| 工具调用 | ✅ ServiceMap | ✅ 并行 | ✅ 并行 | ✅ 并行 | ✅ 顺序 | ✅ 并行 | - | ✅ 插件系统 |
| 部署 | ✅ 分布式 | ✅ 生产 API | 库 | 库 | 库 | 库 | ✅ 分布式 | ✅ 云原生 |
| 状态管理 | 集中式/分布式 | 会话管理 | 基于图 | LangGraph | 基于 Tape | 基于 Tape | Actor 状态 | 管道状态 |
