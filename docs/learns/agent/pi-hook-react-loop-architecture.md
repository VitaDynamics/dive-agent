...
本笔记的完整视觉设计稿（含三层时序图、事件订阅时序、Extension 注册流程，以及与 LangChain v1 Middleware 的能力对照矩阵）请全屏查看：

<a href="/dive-agent/designs/agent/pi-hook-react-loop-architecture.html" target="_blank" rel="noopener noreferrer">📄 全屏查看完整设计稿 →</a>
