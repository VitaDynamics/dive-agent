...
本笔记的完整视觉设计稿（含 TsangerJinKai02 字体、对比表、决策矩阵、代码示例的排版）请全屏查看：

<a href="/dive-agent/designs/agent/langchain-middleware-vs-pi.html" target="_blank" rel="noopener noreferrer">📄 全屏查看完整设计稿 →</a>
